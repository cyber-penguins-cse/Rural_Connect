...
export default function ProductDetail() {
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10">
      <Link to="/products" className="inline-flex items-center gap-2 px-4 py-2 bg-white border border-stone-200 rounded-lg text-sm text-gray-600 hover:text-purple-600 hover:border-purple-300 hover:bg-purple-50 mb-8 group transition-all duration-200 shadow-sm">
